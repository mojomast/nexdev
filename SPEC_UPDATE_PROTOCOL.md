...
- 2026-06-30 M19-RELEASE-READINESS: Added release gate script, Nexdev CI/release workflow updates, release operating/handoff docs, and package-level slow-client publisher overflow coverage without editing `SPEC.md`. Full release acceptance is blocked until `govulncheck ./...` can run and pass in a prepared release environment.
